...
function cacheTest(label, payloads, shouldHitCacheOnSecondRequest) {
  ...
  test('cache - ' + label, function(t) {
    ...
    var dataProvider = injectMetrics(new FixtureProvider({
      ...
      irc_getCode: '6060604052600560005560408060156000396000f3606060405260e060020a60003504633fa4f245811460245780635524107714602c575b005b603660005481565b6004356000556022565b6060908152602090f3',
      irc_getTransactionByHash: function(payload, next, end) {
      ...
      irc_getStorageAt: '0x00000000000000000000000000000000000000000000000000000000deadbeef',
    }));
    // handle dummy block
